...
int get_cic_save(char *cartid, int *cic, int *save) {
    ...
    char *cartIDs[] = {
        ...
        "HP", "EV", "MG", "GU", "SA", "VP", "A2", "WC", "GF", "TR", "TX", "DD",
        "DD","DD","DD","DD","DD","DD","DD","HA", "AF"
    };

    // Banjo-Tooie B7 -> set to sram 'cause crk converts ek16->sram
    int saveTypes[] = {
        2, 1, 5, 1, 3, 1, 1, 3, 3, 3, 3, 3, 3, 5, 3, 5, 3, 3, 3, 4, 5, 4, 5, 3,
        ...
        3, 3, 1, 1, 3, 3, 1, 1, 4, 4, 4, 5, 3, 4, 3, 3, 3, 1, 1, 3, 3, 3, 3, 1,
        1, 1, 1, 1, 1, 1, 1, 3, 5
    };
